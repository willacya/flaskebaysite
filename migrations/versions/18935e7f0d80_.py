...
Revision ID: 18935e7f0d80
Revises: 
Create Date: 2020-07-29 09:37:42.471992
...
def upgrade():
    ...
    sa.Column('driveTime', sa.Float(), nullable=True),
    ...
    sa.Column('minAmount', sa.Integer(), nullable=True),
